...
class CiudadeController extends Controller
{
    ...
    {
         $this->middleware('permission:ver-ciudades|crear-ciudades|editar-ciudades|borrar-ciudades', ['only' => ['index']]);
         $this->middleware('permission:crear-ciudades', ['only' => ['create','store']]);
         $this->middleware('permission:editar-ciudades', ['only' => ['edit','update']]);
         $this->middleware('permission:borrar-ciudades', ['only' => ['destroy']]);
    }
