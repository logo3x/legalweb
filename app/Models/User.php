...
#[Fillable(['name', 'email', 'password', 'firm_id', 'role', 'google_id', 'avatar', 'terms_accepted_at', 'terms_ip', 'tour_completed_at', 'last_login_at', 'login_count', 'security_email_enabled'])]
